...
1:1 and 1:N relationships between archetyped content elements (e.g. `Entries`) can be expressed by using one, or more than one, respectively, `LINKs`. Chains of links can be used to see  problem threads  or other logical groupings of items.
