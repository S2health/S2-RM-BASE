...
h|*0..1*
|*location*: `link:/releases/BASE/{base_release}/patterns.html#_party_identified_class[Party_identified^]`
...
h|*0..1*
|*subject*: `link:/releases/BASE/{base_release}/patterns.html#_party_proxy_class[Party_proxy^]`
a|Identifiers for subject of the received information item.

h|*0..1*
|*provider*: `link:/releases/BASE/{base_release}/patterns.html#_party_identified_class[Party_identified^]`
