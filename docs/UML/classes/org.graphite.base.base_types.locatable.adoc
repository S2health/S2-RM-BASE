...
If populated, the code must match that found in a terminology service lookup for the internal code carried in the `_archetype_node_id_` field. Any other value will generate an error in validation.
