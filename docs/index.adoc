...
|Republished form of the {openehr_rm_common}#_change_control_package[openEHR Change Control package^] with class names converted to mixed snake-case. No other changes.
