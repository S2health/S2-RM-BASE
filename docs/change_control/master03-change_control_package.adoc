...
include::{uml_export_dir}/classes/{pkg}versionedobject.adoc[]

include::{uml_export_dir}/classes/{pkg}version.adoc[]

include::{uml_export_dir}/classes/{pkg}originalversion.adoc[]

include::{uml_export_dir}/classes/{pkg}importedversion.adoc[]

include::{uml_export_dir}/classes/{pkg}contribution.adoc[]

include::{uml_export_dir}/classes/{pkg}auditdetails.adoc[]
