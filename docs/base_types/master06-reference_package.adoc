...
include::{uml_export_dir}/classes/{pkg}partyproxy.adoc[]

include::{uml_export_dir}/classes/{pkg}partyself.adoc[]

include::{uml_export_dir}/classes/{pkg}partyidentified.adoc[]

include::{uml_export_dir}/classes/{pkg}partyrelated.adoc[]
