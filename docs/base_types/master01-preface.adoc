...
This specification is in the {spec_status} state. The development version of this document can be found at {s2_base_latest_base_types}[{s2_base_latest_base_types}^].
