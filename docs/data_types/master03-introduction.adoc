...
Accordingly, the types defined here have been derived from the {openehr_rm_data_types}[openEHR Data Types^] and the {hl7_fhir_data_types}[HL7 FHIR Data Types^].
