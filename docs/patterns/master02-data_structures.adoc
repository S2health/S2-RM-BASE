...
The `base.patterns.data_structures` package contains classes representing structures for recording events in past time. The
`data_structures package` is illustrated below.
